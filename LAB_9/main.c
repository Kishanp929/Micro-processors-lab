...
void main(void)
{
	...
	while(1)
	{
		...
		*/	
		...
		lcd_cmd(0xC0);
		int_to_string(*adc_ip_data_ascii ,5);
		...
		*/
	    ...
	    lcd_cmd(0x80);	
		lcd_write_string(display_msg1);
	     adc_ip_data_ascii[0] = adc_data%10 +48;
		 adc_data /= 10; 
		 
		 adc_ip_data_ascii[1] = adc_data%10 +48;
		 adc_data /= 10; 

         adc_ip_data_ascii[2] = adc_data%10 +48;
		 adc_data /= 10;

		 adc_ip_data_ascii[3] = adc_data%10 +48;
		 adc_data /= 10;  

		 adc_ip_data_ascii[4] = adc_data%10 +48;
		 adc_data /= 10;  
       for( i = 4; i>=0 ;i--)
	    {
			lcd_write_char(adc_ip_data_ascii[i]);
		}
